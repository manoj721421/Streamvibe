...
import { fetchMovieDetails } from '../Store/MovieDetail';
...
const MovieDetails = () => {
    ...
    return (
        <>
            ...
            <div style={{ height: "85vh", backgroundImage: `url(https://image.tmdb.org/t/p/original/${data.details.backdrop_path})`, backgroundRepeat: "no-repeat", backgroundSize: "cover",backgroundPosition:"center" }}>
                        ...
                        <div className='p-3 background-dark border border-secondary rounded rounded-3'>
                                ...
                                <div className="d-flex">
                                    {
                                        data.details?.spoken_languages?.map((lang) => {
                                            return <p className='background-black p-1 me-2 rounded border border-secondary'>{lang?.name}</p>
                                        })
                                    }
                                </div>
                            </div>
                            ...
                            <div className="mt-4 ">
                                ...
                                <div className='p-2 border border-secondary rounded background-black'>
                                    {
                                        data.details?.crew?.filter((crew) => crew?.job === "Director").map((director) => {
                                            return (
                                                <div className='d-flex'>
